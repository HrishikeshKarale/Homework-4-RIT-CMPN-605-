...
* Exceptions.java
*
* @version   $Id: Exceptions.java,v_1.0 2014/09/23 12:20:00
*
...
class Exceptions
{
    ...
    public static void main(String agrs[])throws Exception
	{
        ...
        /*
         * The below try-catch block checks for NoSuchElementException and
         * handel's the exception using a catch block.A NoSuchElementException
         * is generated if there are no more elements to be read or to indicate
         * that the element being requested doesnt exist.
         */
        
        try
		{
            Scanner scr= new Scanner(new FileReader("mecbeth.txt"));
	        str= scr.nextLine();
	    }
		...
		{
            System.out.println("Negative Size Array: "+e);
            e.printStackTrace();
        	System.out.println();
        }
   }
